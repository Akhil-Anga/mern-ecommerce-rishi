...
### Note: A related project for an end-to-end encrypted chat application is available at [mern-chat](https://github.com/RishiBakshii/mern-chat) using Next.js, Prisma, Postgresql, Express, and Socket.io.
...
```bash
  git clone https://github.com/Akhil-Anga/mern-ecommerce.git
```
...
## Maintainer
- [Venkata Sai Akhil Anga](https://github.com/Akhil-Anga)
- Original project by Rishi Bakshi

## About the Developer
Venkata Sai Akhil Anga is a Full Stack Developer with 5 years of experience designing and delivering scalable enterprise applications using Java, Spring Boot, Python, React.js, Angular, Node.js, REST APIs, SQL, and AWS. He specializes in developing cloud-native applications, microservices, and responsive web solutions while optimizing performance, security, and system scalability.
